...
public class Media_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // the "home screen"
                Intent i = new Intent(Media_Main.this, Vehicle_Specification.class);
                startActivity(i);
            }
        });
        ...
        Logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Intent i = new Intent(Media_Main.this, User_Login.class);
    ...
    private class CustomAdapter extends FragmentPagerAdapter {
        ...
        private String fragments[] = {"Images", "Videos"};
